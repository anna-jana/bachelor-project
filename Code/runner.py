...
if __name__ == "__main__":
    ...
    f_a = (1e9, 1e19)
    solver = eom_solver.EOMSolver(axion_mass.m_a_from_chi_general, g_star.shellard_fit, potential.cosine)
    ...
    solver = eom_solver.EOMSolver(axion_mass.m_a_from_chi_general, g_star.shellard_fit, potential.harmonic)
    theta_i_s, f_a_s, Omega_a_h_sq = compute_density_parameter(theta_i, f_a, solver , N=(N,N))
